...
export default function HomeHero({ movie }) {
  ...
  return (
    <section className="relative flex min-h-0 w-full flex-1 items-center overflow-hidden pt-22">
      ...
      <div className="relative z-10 flex w-full max-w-6xl flex-col px-6 md:pl-10 md:pr-12">
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold leading-tight text-ink drop-shadow-lg md:text-6xl">
            {movie.title}
          </h1>
          {movie.release_date && (
          ...
          <div className="mt-6 flex gap-3">
            <motion.button
              ...
              className="flex items-center gap-2 rounded-full px-7 py-3 text-sm font-bold text-ink"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              onClick={() => openMovie(movie)}
              className="rounded-full px-7 py-3 text-sm font-bold text-ink glass"
            >
              More Info
            </motion.button>
          </div>
